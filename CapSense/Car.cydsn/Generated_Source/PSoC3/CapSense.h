...
#define CapSense_PRS_OPTIONS                (1u)
...
/* Measure REGs  definitions */
    ...
    #if (CY_PSOC5A)
        #define CapSense_PWM_CH0_CONTROL2_REG   (*(reg8 *) CapSense_MeasureCH0_FF_Window__CFG1 )
        #define CapSense_PWM_CH0_CONTROL2_PTR   ( (reg8 *) CapSense_MeasureCH0_FF_Window__CFG1 )
    #else
    ...
    #if (CY_PSOC5A)
        #define CapSense_RAW_CH0_CONTROL2_REG   (*(reg8 *) CapSense_MeasureCH0_FF_Counter__CFG1 )
        #define CapSense_RAW_CH0_CONTROL2_PTR   ( (reg8 *) CapSense_MeasureCH0_FF_Counter__CFG1 )
    #else
    ...
    #define CapSense_RAW_CH0_AUX_CONTROL_PTR     ( (reg8 *) \
        ...
        #if (CY_PSOC5A)
            #define CapSense_PWM_CH1_CONTROL2_REG   (*(reg8 *) CapSense_MeasureCH1_FF_Window__CFG1 )
            #define CapSense_PWM_CH1_CONTROL2_PTR   ( (reg8 *) CapSense_MeasureCH1_FF_Window__CFG1 )
        #else
        ...
        #if (CY_PSOC5A)
            #define CapSense_RAW_CH1_CONTROL2_REG   (*(reg8 *) CapSense_MeasureCH1_FF_Counter__CFG1 )
            #define CapSense_RAW_CH1_CONTROL2_PTR   ( (reg8 *) CapSense_MeasureCH1_FF_Counter__CFG1 )
        #else
...
#if (CY_PSOC5A)
    #define CapSense_PRESCALER_CTRL_CMP_MODE_SHIFT  (0x01u)
#else
...
#if (CY_PSOC5A)
    #define CapSense_MEASURE_CTRL_MODE_SHIFT        (0x01u)
#else
