...
typedef struct CapSense_IdacCH0_backupStruct
{
    uint8 enableState;
    uint8 data_value;
    ...
    typedef struct _CapSense_IdacCH0_lowPowerBackupStruct
    {
        uint8 DACCR0Reg;
...
#define CapSense_IdacCH0_DEFAULT_SPEED     ((0u ? 1u:0u)*2)  /* Default DAC speed */
